...
#define LEN sizeof(struct MAPSSr)
#define FRE sizeof(struct FREEZE)
typedef struct MAPSSr *PMAPSS;    //存储maps的链表
...
PMAPSS Res=NULL;//全局buff(保存数据的地方)
...
PMAPSS readmaps(char *bm,int type);
PMAPSS readmaps_all(char *bm);//读取maps文件
PMAPSS readmaps_bad(char *bm);//读取maps文件
PMAPSS readmaps_c_alloc(char *bm);//读取maps文件
PMAPSS readmaps_c_bss(char *bm);//读取maps文件
PMAPSS readmaps_c_data(char *bm);//读取maps文件
PMAPSS readmaps_c_heap(char *bm);//读取maps文件
PMAPSS readmaps_java_heap(char *bm);//读取maps文件
PMAPSS readmaps_a_anonmyous(char *bm);//读取maps文件
PMAPSS readmaps_code_system(char *bm);//读取maps文件
PMAPSS readmaps_stack(char *bm);//读取maps文件
PMAPSS readmaps_ashmem(char *bm);//读取maps文件

void BaseAddressSearch(char *bm,char *value,int *gs,int type,long int BaseAddr);//基址搜索
PMAPSS BaseAddressSearch_DWORD(char *bm,int value,int *gs,long int BaseAddr,PMAPSS pMap);//DWORD
PMAPSS BaseAddressSearch_FLOAT(char *bm,float value,int *gs,long int BaseAddr,PMAPSS pMap);//FLOAT

void RangeMemorySearch(char *bm,char *from_value,char *to_value,int *gs,int type);//范围搜索
PMAPSS RangeMemorySearch_DWORD(char *bm,int from_value,int to_value,int *gs,PMAPSS pMap);//DWORD
PMAPSS RangeMemorySearch_FLOAT(char *bm,float from_value,float to_value,int *gs,PMAPSS pMap);//FLOAT

void MemorySearch(char *bm,char *value,int *gs,int TYPE);//类型搜索,这里value需要传入一个地址
PMAPSS MemorySearch_DWORD(char *bm,int value,int *gs,PMAPSS pMap);  //内存搜索DWORD
PMAPSS MemorySearch_FLOAT(char *bm,float value,int *gs,PMAPSS pMap);  //内存搜索FLOAT

void MemoryOffset(char *bm,char *value,long int offset,int *gs,int type);//搜索偏移
PMAPSS MemoryOffset_DWORD(char *bm,int value,long int offset,PMAPSS pBuff,int *gs);//搜索偏移DWORD
PMAPSS MemoryOffset_FLOAT(char *bm,float value,long int offset,PMAPSS pBuff,int *gs);//搜索偏移FLOAT

void RangeMemoryOffset(char *bm,char *from_value,char *to_value,long int offset,int *gs,int type);//范围偏移
PMAPSS RangeMemoryOffset_DWORD(char *bm,int from_value,int to_value,long int offset,PMAPSS pBuff,int *gs);//搜索偏移DWORD
PMAPSS RangeMemoryOffset_FLOAT(char *bm,float from_value,float to_value,long int offset,PMAPSS pBuff,int *gs);//搜索偏移FLOAT

void MemoryWrite(char *bm,char *value,long int offset,int type);	//内存写入
int MemoryWrite_DWORD(char *bm,int value,PMAPSS pBuff,long int offset);	//内存写入DWORD
int MemoryWrite_FLOAT(char *bm,float value,PMAPSS pBuff,long int offset);	//内存写入FLOAT
...
void ClearMaps(PMAPSS pMap);//清空maps

int isapkinstalled(char *bm);//检测应用是否安装
int isapkrunningl(char *bm);//检测应用是否运行
...
int rebootsystemm();//重启系统(手机)
int PutDate();//输出系统日期
int GetDate(char *date);//获取系统时间

PMAPSS GetResults();//获取结果,返回头指针
...
PMAPSS readmaps(char* bm,TYPE type)
{
PMAPSS pMap=NULL;
switch (type)
{
...
PMAPSS readmaps_all(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew;
PMAPSS pEnd;
pEnd=pNew=(PMAPSS)malloc(LEN);
FILE *fp;
int i = 0,flag=1;
char lj[64], buff[256];
int pid = getPID(bm);
...
PMAPSS readmaps_bad(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_c_alloc(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_c_bss(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_c_data(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_c_heap(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_java_heap(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_a_anonmyous(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_code_system(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_stack(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
PMAPSS readmaps_ashmem(PACKAGENAME *bm)
{
PMAPSS pHead=NULL;
PMAPSS pNew=NULL;
PMAPSS pEnd=NULL;
...
void BaseAddressSearch(PACKAGENAME *bm,char *value,COUNT *gs,TYPE type,ADDRESSSr BaseAddr)
{
PMAPSS pHead=NULL;
PMAPSS pMap=NULL;
...
PMAPSS BaseAddressSearch_DWORD(PACKAGENAME *bm,int value,COUNT *gs,ADDRESSSr BaseAddr,PMAPSS pMap)
{
*gs=0;
...
PMAPSS BaseAddressSearch_FLOAT(PACKAGENAME *bm,float value,COUNT *gs,ADDRESSSr BaseAddr,PMAPSS pMap)
{
*gs=0;
pid_t pid=getPID(bm);
if (pid == 0)
...
PMAPSS RangeMemorySearch_DWORD(PACKAGENAME *bm,int from_value,int to_value,COUNT *gs,PMAPSS pMap)//DWORD
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
PMAPSS RangeMemorySearch_FLOAT(PACKAGENAME *bm,float from_value,float to_value,COUNT *gs,PMAPSS pMap)//FLOAT
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
PMAPSS MemorySearch_DWORD(PACKAGENAME *bm,int value,COUNT *gs,PMAPSS pMap)
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
PMAPSS MemorySearch_FLOAT(PACKAGENAME *bm,float value,COUNT *gs,PMAPSS pMap)
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
PMAPSS MemoryOffset_DWORD(PACKAGENAME *bm,int value,OFFSET offset,PMAPSS pBuff,COUNT *gs)//搜索偏移
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
PMAPSS MemoryOffset_FLOAT(PACKAGENAME *bm,float value,OFFSET offset,PMAPSS pBuff,COUNT *gs)//搜索偏移
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
PMAPSS RangeMemoryOffset_DWORD(PACKAGENAME *bm,int from_value,int to_value,OFFSET offset,PMAPSS pBuff,COUNT *gs)//搜索偏移DWORD
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
PMAPSS RangeMemoryOffset_FLOAT(PACKAGENAME *bm,float from_value,float to_value,OFFSET offset,PMAPSS pBuff,COUNT *gs)//搜索偏移FLOAT
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
int MemoryWrite_DWORD(PACKAGENAME *bm,int value,PMAPSS pBuff,OFFSET offset)
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
int MemoryWrite_FLOAT(PACKAGENAME *bm,float value,PMAPSS pBuff,OFFSET offset)
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
void *SearchAddress(PACKAGENAME *bm,ADDRESSSr addr)//返回一个void指针,可以自行转换类型
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
int WriteAddress(PACKAGENAME *bm,ADDRESSSr addr,void *value,TYPE type)
{
pid_t pid=getPID(bm);
if (pid == 0)
{
...
int isapkrunningl(PACKAGENAME *bm)
{
DIR *dir=NULL;
struct dirent *ptr=NULL;
FILE *fp=NULL;
...
int AddFreezeItem(PACKAGENAME *bm,ADDRESSSr addr,char *value,TYPE type,OFFSET offset)
{
switch (type)
{
case DWORD:
...
int AddFreezeItem_DWORD(PACKAGENAME *bm,ADDRESSSr addr,char *value)
{
...
int AddFreezeItem_FLOAT(PACKAGENAME *bm,ADDRESSSr addr,char *value)
{
if (FreezeCount == 0)//如果没有数据
{
Pfreeze=pEnd=pNew=(PFREEZE)malloc(FRE);//分配新空间
...
int RemoveFreezeItem(ADDRESSSr addr)
{
PFREEZE pTemp=Pfreeze;
PFREEZE p1=NULL;
PFREEZE p2=NULL;
